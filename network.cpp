...
int main()
{
//	DevReaderBsd	DR("john");
	list<string>	lst;
	list<string>::iterator	it;

	lst = DevReaderBsd::findAllDevices();
	it = lst.begin();
	while (it != lst.end())
	{
		std::cout << *it << std::endl;
	DevReaderBsd	DR(*it);
	DataFrame	DF = DR.getNewDataFrame();
	DR.readFromDevice(DF);
	std::cout << DF.getTotalDataIn()          << std::endl;
	std::cout << DF.getTotalDataOut()         << std::endl;
	std::cout << DF.getTotalPacketsIn()       << std::endl;
	std::cout << DF.getTotalPacketsOut()      << std::endl;
	std::cout << "********************" << std::endl;
	// std::cout << DF.getTotalErrorsIn()        << std::endl;
	// std::cout << DF.getTotalErrorsOut()       << std::endl;
	// std::cout << DF.getTotalDropsIn()         << std::endl;
	// std::cout << DF.getTotalDropsOut()        << std::endl;
	// std::cout << DF.getTimeStampSeconds()     << std::endl;
	// std::cout << DF.getTimeStampMicroseconds() << std::endl;
